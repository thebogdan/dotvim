...
" ROBS NOTES: UNDERLINE & STRIKETHROUGH CHARACTERS
...
" ROBS NOTES: I disabled this thing, I hated it
...
" ROBS NOTES: Drawing boxes
Plug 'gyim/vim-boxdraw'
" ROBS NOTES: Added UnconditionalPaste for "*gcp
Plug 'vim-scripts/UnconditionalPaste'
" ROBS NOTES: Make tables in vim
Plug 'dhruvasagar/vim-table-mode'
let g:table_mode_corner_corner='+'
let g:table_mode_header_fillchar='='
" ROBS NOTES: Calendar addon
...
" ROBS NOTES: this is failing on :so %
...
" ROBS NOTES: I don't know what this does but it seems to conflict
